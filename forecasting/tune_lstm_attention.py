...
class LSTMAttentionTuner:
    ...
    def run_tuning(self, search_space, max_time_per_config=300):
        """
        Run hyperparameter tuning with early stopping optimization.
        ...
        print(f"\n{'='*70}")
        print(f"LSTM-Attention Hyperparameter Tuning (OPTIMIZED)")
...
Examples:
  ...
  python tune_lstm_attention.py --config config_lstm_attention_test.yaml --mode auto
    ...
    parser.add_argument('--output', default='lstm_attention_tuning_results.yaml',
                        help='Output file for results (default: lstm_attention_tuning_results.yaml)')
